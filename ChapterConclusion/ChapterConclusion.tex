...
%In this final chapter, we first summarize the contributions made to both parts of the thesis: \textbf{Part \ref{part:Filter}} and \textbf{Part \ref{part:PA}}. Then, I propose some possible further improvements to extend this work in future research.

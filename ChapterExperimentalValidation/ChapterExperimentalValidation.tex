...
The experimental results validate the data-driven step input estimation method and indicate in which intervals of SNR and sample size the method is reliable.

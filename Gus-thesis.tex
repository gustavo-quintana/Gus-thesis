...
\usepackage{babel, array, verbatim, float, booktabs, units, amsmath, amssymb, graphicx, tikz}
\usepackage{mathdots, amsthm, textcomp, times, mathptmx, mathtools, bm, amsbsy}
...
\bibliographystyle{apalike} % wmaainf

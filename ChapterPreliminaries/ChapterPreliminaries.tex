...
In the next subsections the input is modeled as a multiple of the unit step function, to describe methods to estimate the input step level in two conditions: when the model of the sensor is a-priori given and when the method is not available. 

\subsubsection{Step input estimation with system model}
...
A third method directly estimates the input step level from the step response, without the identification of a sensor model.
